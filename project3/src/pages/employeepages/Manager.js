  ...
  */
  ...
  const handlePositionSwitch = async (employeeId, newPosition) => {
    ...
    try {
      ...
      const response = await fetch(`http://3.17.222.225:5000/api/employees/${employeeId}`, {
        method: 'PUT',
        headers: {
      ...
      const passwordResponse = await fetch(`http://3.17.222.225:5000/api/employees/${employeeId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  //     const response = await fetch(`http://3.17.222.225:5000/api/ingredients/${name}`, {
  //       method: "PUT",
  //       headers: {
  //         "Content-Type": "application/json",
  //       },
  ...
  const handleDeleteIngredient = async (id) => {
    console.log("hello");
    try {
      const response = await fetch(`http://3.17.222.225:5000/api/ingredients/${id}`, {
        method: 'DELETE',
      });
  ...
  const handleAddIngredient = async () => {
    try {
      const response = await fetch('http://3.17.222.225:5000/api/ingredients', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const processProductUsageChart = () => {
    if (PRODstartDate && setPRODStartDate) {
      fetch(`http://3.17.222.225:5000/api/product-usage-chart?start=${PRODstartDate}&end=${PRODendDate}`)
  ...
  useEffect(() => {
    ...
    fetch('http://3.17.222.225:5000/api/inventory')
      .then(response => response.json())
      .then(data => setInventory(data))
      .catch(error => console.error('Error:', error));
    fetch('http://3.17.222.225:5000/api/ingredients')
      .then(response => response.json())
  ...
  const handleQuantityUpdate = () => {
    ...
    if (selectedItem && newQuantity !== '') {
      fetch(`http://3.17.222.225:5000/api/inventory/${selectedItem}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const processSalesReport = () => {
    ...
    if (SALEstartDate && SALEendDate) {
      fetch(`http://3.17.222.225:5000/api/sales-report?start=${SALEstartDate}&end=${SALEendDate}`)
        .then(response => response.json())
  ...
  const processExcessReport = () => {
    if (thresholdDate) {
      fetch(`http://3.17.222.225:5000/api/excess-report?thresholdDate=${thresholdDate}`)
        .then(response => response.json())
  ...
  const processRestockReport = () => {
    fetch('http://3.17.222.225:5000/api/restock-report')
      .then(response => response.json())
   ...
   */
  const fetchItems = () => {
    fetch('http://3.17.222.225:5000/api/items')
      .then(response => response.json())
      .then(data => {
          setItems(data);
  ...
  const handleDeleteItem = (name) => {
    fetch(`http://3.17.222.225:5000/api/items/${name}`, {
      method: 'DELETE',
    })
      .then(response => response.json())
      .then(() => {
  ...
  const processTrendReport = () => {
    if (PAIRstartDate && PAIRendDate) {
      fetch(`http://3.17.222.225:5000/api/trend-report?start=${PAIRstartDate}&end=${PAIRendDate}`)
        .then(response => response.json())
  ...
  const processPopularityAnalysis = () => {
    if (startDate && endDate) {
      fetch(`http://3.17.222.225:5000/api/popularity-analysis?start=${startDate}&end=${endDate}`)
        .then(response => response.json())
